...
set_property PACKAGE_PIN U2 [get_ports {anodes_o[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {anodes_o[0]}]
set_property PACKAGE_PIN U4 [get_ports {anodes_o[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {anodes_o[1]}]
set_property PACKAGE_PIN V4 [get_ports {anodes_o[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {anodes_o[2]}]
set_property PACKAGE_PIN W4 [get_ports {anodes_o[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {anodes_o[3]}]
...
set_property PACKAGE_PIN W19 [get_ports start_i]
	set_property IOSTANDARD LVCMOS33 [get_ports start_i]
set_property PACKAGE_PIN T17 [get_ports reset_i]
